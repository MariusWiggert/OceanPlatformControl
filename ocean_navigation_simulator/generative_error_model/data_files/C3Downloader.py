    ...
    def __init__(self, forecast_hindcast: str = "forecast"):
        ...
        if forecast_hindcast == "forecast":
            self.data_dir = os.path.join(
                get_path_to_project(os.getcwd()), "data/drifter_data/forecasts/"
            )
        if forecast_hindcast == "hindcast":
            self.data_dir = os.path.join(
                get_path_to_project(os.getcwd()), "data/drifter_data/hindcasts/"
            )
...
if __name__ == "__main__":
    ...
    time_interval = [
        datetime.datetime(2022, 5, 2, 12, 0, 0),
        datetime.datetime(2022, 10, 8, 12, 0, 0),
    ]
