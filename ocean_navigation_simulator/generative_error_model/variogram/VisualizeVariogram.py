...
class VisualizeVariogram:
    ...
    def read_variogram_from_file(self, file_name: str=None):
        ...
        self.variogram = Variogram()
        variogram_data = load_variogram_from_npy(variogram_file)
        ...
        self.variogram.detrend_statistics = variogram_data[4]
...
def load_variogram_from_npy(file_path: str):
    ...
    return bins, bins_count, res, units, detrend_statistics
