...
def build_q_model_and_distribution(
    ...
    if config.get('custom_model'):
        ...
        print('')
        print('')
        model = config.get('custom_model')(obs_space, action_space, config["model"], **config["model"]["custom_model_config"])
        policy.target_model = config.get('custom_model')(obs_space, action_space, config["model"], **config["model"]["custom_model_config"])
