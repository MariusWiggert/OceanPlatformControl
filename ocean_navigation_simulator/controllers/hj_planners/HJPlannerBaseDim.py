...
class HJPlannerBaseDim(Controller):
    ...
    Baseclass for all HJ reachability-based Planners using backwards/forwards/multi-time reachability.
        ...
        In the Baseclass, the PDE is solved in dimensional dynamics in space and time to reduce numerical errors.
    ...
    def __init__(self, problem: NavigationProblem, specific_settings: dict):
        ...
        # Initialize variables needed for solving the PDE in dimensional terms
        self.dim_dynamics = None

        self.planner_cache_index = 0

        # Initialize the dimensional_dynamics and within it the dimensional_dynamics
    ...
    def _run_hj_reachability(
        ...
        # solve the PDE in dimensional to get the value function V(s,t)
        start = time.time()
