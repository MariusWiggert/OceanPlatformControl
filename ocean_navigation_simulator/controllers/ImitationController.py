...
class ImitationController(HJReach2DPlanner):
    ...
    def __init__(
        ...
        self.model = torch.load(f'{dirname(abspath(__file__))}/../../models/value_function_learning/baseline.pth')
    ...
    def get_action(self, observation: ArenaObservation) -> PlatformAction:
        ...
        self.true_currents = np.append(self.true_cuurents, np.expand_dims(np.array([
