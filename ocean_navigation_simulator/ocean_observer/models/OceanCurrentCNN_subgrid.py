...
class OceanCurrentCNNSubgrid(nn.Module):
    def __init__(self):
        ...
        self.first_layers = nn.Sequential(
            nn.Conv3d(in_channels=2, out_channels=32, kernel_size=(24, 4, 4), stride=(4, 2, 2)),  # , stride=(3,3,12))
            nn.ReLU(),
        ...
        # Upsampling
        self.linear_up_sampling = nn.Sequential(nn.Linear(input_size // 8, input_size // 32),
