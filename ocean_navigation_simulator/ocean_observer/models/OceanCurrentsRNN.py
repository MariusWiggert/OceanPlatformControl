...
class OceanCurrentRNN(nn.Module):
    ...
    def __init__(self, input_shape, hidden_size, output_shape, type_cell: str, size_layers_after_rnn: List[int] = [],
                 ...
                 non_linearity: Optional[str] = None, init_weights_function: str = 'randn', index_time_dimension=2):
    ...
    def init_hidden(self, batch_size):
        ...
        return autograd.Variable(self.init_weights_function(shape)), autograd.Variable(torch.randn(shape))
