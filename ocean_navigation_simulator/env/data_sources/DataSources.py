...
# TODO: currently not used because mixing doesn't work in Python...
class AnalyticalDataSource(DataSource):
    ...
    def get_data_over_area(self, x_interval: List[float], y_interval: List[float],
        ...
        # Step 3: Do a sanity check for the sub-setting before it's used outside and leads to errors
        self.array_subsetting_sanity_check(subset, x_interval, y_interval, t_interval)
