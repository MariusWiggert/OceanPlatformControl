...
solar_field = SolarIrradianceField.SolarIrradianceField(
...
solar_field.hindcast_data_source.plot_data_at_time_over_area(
    time=t_0, x_interval=x_interval, y_interval=y_interval, spatial_resolution=5
)
#%% Animate it over time
solar_field.hindcast_data_source.animate_data(
    x_interval=x_interval,
    y_interval=y_interval,
    t_interval=t_interval,
    spatial_resolution=5,
    temporal_resolution=3600 * 3,
    output="solar_test_animation.mp4",
)
#%% check it for a spatio-temporal area
area_xarray = solar_field.get_ground_truth_area(
    x_interval=x_interval,
    y_interval=y_interval,
    t_interval=t_interval,
    spatial_resolution=5,
