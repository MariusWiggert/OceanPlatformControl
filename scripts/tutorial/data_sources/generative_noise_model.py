...
arena_config = {
    ...
    'platform_dict': {'battery_cap_in_wh': 400.0, 'u_max_in_mps': 0.1, 'motor_efficiency': 1.0,
                      'solar_panel_size': 0.5, 'solar_efficiency': 0.2, 'drag_factor': 675.0, 'dt_in_s': 1800.0},
...
t_interval = [datetime.datetime(2022, 10, 1, 13, 30, 0),
              datetime.datetime(2022, 10, 1, 20, 30, 0)]
