...
# % Specify Problem
x_0 = PlatformState(lon=units.Distance(deg=-81.749), lat=units.Distance(deg=18.839),
...
data_xarray_true = arena.ocean_field.hindcast_data_source.get_data_over_area(
    ...
    spatial_resolution=planner.specific_settings['grid_res'])
#%%
data_xarray_true_interp = data_xarray_true.interp_like(data_xarray_fmrc, method='linear', assume_sorted=False, kwargs=None)
#%%
