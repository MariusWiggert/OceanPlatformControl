...
# Note only u_current_analytical and v_current_analytical are working, the plotting is not adjusted to ensemble data yet
n_ensembles = 10
a_vector = np.random.uniform(0.1, 1, n_ensembles)
