...
# Note: The Mission times out in this setting so don't be surprised =)
# %% imports
import datetime
import logging
...
#%% For testing the GP
# This plots the GP output
x_interval = [-83, -81]
y_interval = [23, 25]
t_interval = [
    datetime.datetime(2022, 9, 11, 0, 2, 0, 4573, tzinfo=datetime.timezone.utc),
    datetime.datetime(2022, 9, 12, 0, 2, 0, 4573, tzinfo=datetime.timezone.utc)]
data = observer.get_data_over_area(x_interval=x_interval, y_interval=y_interval, t_interval=t_interval, output='GP')
arena.ocean_field.hindcast_data_source.plot_data_from_xarray(time_idx=0, xarray=data)
import matplotlib.pyplot as plt
plt.show()
#%% # This plots the hindcast output (difference?)
x_interval = [-83, -81]
y_interval = [23, 25]
t_interval = [
    datetime.datetime(2022, 9, 11, 0, 2, 0, 4573, tzinfo=datetime.timezone.utc),
    datetime.datetime(2022, 9, 12, 0, 2, 0, 4573, tzinfo=datetime.timezone.utc)]
data = arena.ocean_field.hindcast_data_source.get_data_over_area(x_interval=x_interval, y_interval=y_interval, t_interval=t_interval)
arena.ocean_field.hindcast_data_source.plot_data_from_xarray(time_idx=0, xarray=data)
import matplotlib.pyplot as plt
plt.show()
#%% # This plots the forecast data (difference?)
x_interval = [-83, -81]
y_interval = [23, 25]
t_interval = [
    datetime.datetime(2022, 9, 11, 0, 2, 0, 4573, tzinfo=datetime.timezone.utc),
    datetime.datetime(2022, 9, 12, 0, 2, 0, 4573, tzinfo=datetime.timezone.utc)]
data = arena.ocean_field.forecast_data_source.get_data_over_area(x_interval=x_interval, y_interval=y_interval, t_interval=t_interval)
arena.ocean_field.hindcast_data_source.plot_data_from_xarray(time_idx=0, xarray=data)
import matplotlib.pyplot as plt
plt.show()
