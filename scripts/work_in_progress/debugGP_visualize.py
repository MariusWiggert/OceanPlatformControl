...
data = observer.get_data_over_area(
    x_interval=x_interval, y_interval=y_interval, t_interval=t_interval, output="GP"
)
...
data = arena.ocean_field.hindcast_data_source.get_data_over_area(
...
data = arena.ocean_field.forecast_data_source.get_data_over_area(
    x_interval=x_interval, y_interval=y_interval, t_interval=t_interval
)
arena.ocean_field.hindcast_data_source.plot_data_from_xarray(time_idx=0, xarray=data)
import matplotlib.pyplot as plt
