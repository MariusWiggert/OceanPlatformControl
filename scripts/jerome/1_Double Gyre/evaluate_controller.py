...
controller = RLControllerFromAgent(
    problem=factory.next_problem(), agent=agent, feature_constructor=DoubleGyreFeatureConstructor()
)
...
clean_ray_results.evaluation_run(
    iteration_limit=10, delete=True, filter_string="PPOTrainer", ignore_last=False
)
