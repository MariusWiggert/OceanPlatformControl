...
def run():
    ...
    os.makedirs(paths.DATA + "missions", exist_ok=True)
    ...
    failed_missions = all_missions[~all_missions["HJ_success"]]
    ...
    print(
        f'Naive Average Success: {feasible_missions["Naive_success"].mean():.1%} of Feasible Missions'
    )
