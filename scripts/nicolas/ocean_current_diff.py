...
# Accessing data via local files for forecasts and hindcasts
...
# Forecast
forecast_xarray = ocean_field.get_forecast_area(x_interval=x_interval, y_interval=y_interval, t_interval=t_interval,
...
print("RMSE Error is: ", np.sqrt(error_array['water_u']**2 + error_array['water_v']**2).mean().item())
