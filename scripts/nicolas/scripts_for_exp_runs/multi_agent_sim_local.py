"""
This script is to run a simulation of a multi-platform scenario locally, with
a similar structure as when it is run on c3. The metrics and some plots/animations 
are also logged.
"""
# %% imports
import logging
...
HJMultiTimeConfig = {
    ...
    "T_goal_in_seconds": 3600 * 24 * 5,  # 5d
    "accuracy": "high",
