  ...
  """
    ...
    """
        ...
        if not self.measurement_locations:
            print("no measurement_locations")
            ...
            #print("inputs:",inputs[:,-1], type(inputs[:,-1]))
            ...
            print("after fitting, after predict")
            print("output predict:",means, deviations)
