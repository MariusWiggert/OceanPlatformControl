...
# %%
from ocean_navigation_simulator.utils.calc_fmrc_error import calc_speed_RMSE, calc_abs_angle_difference, \
...
vec_corr = calc_vector_corr_over_time(HYCOM_Forecast.to_array().to_numpy().transpose((1, 2, 3, 0)),
...
# interpolate
val_at_t = interp1d(
    gt_run_simulator.high_level_planner.reach_times - gt_run_simulator.high_level_planner.reach_times[0],
    gt_run_simulator.high_level_planner.all_values, axis=0, kind='linear')(
...
# %%
sim.high_level_planner.plot_reachability_animation(type='mp4', multi_reachability=True, granularity_in_h=1,
                                                   time_to_reach=True)
